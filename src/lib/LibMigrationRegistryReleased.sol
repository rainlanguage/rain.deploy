...
import {
    DEPLOYED_ADDRESS as MigrationRegistry_0_1_7_DEPLOYED_ADDRESS,
    BYTECODE_HASH as MigrationRegistry_0_1_7_BYTECODE_HASH,
    CREATION_CODE as MigrationRegistry_0_1_7_CREATION_CODE,
    RUNTIME_CODE as MigrationRegistry_0_1_7_RUNTIME_CODE,
...
import {
    DEPLOYED_ADDRESS as MigrationRegistry_0_1_11_DEPLOYED_ADDRESS,
    BYTECODE_HASH as MigrationRegistry_0_1_11_BYTECODE_HASH,
    CREATION_CODE as MigrationRegistry_0_1_11_CREATION_CODE,
    RUNTIME_CODE as MigrationRegistry_0_1_11_RUNTIME_CODE,
    DEPENDENCIES as MigrationRegistry_0_1_11_DEPENDENCIES
} from "../generated/0_1_11/MigrationRegistry.sol";
...
library LibMigrationRegistryReleased {
    ...
    function releasedSuites() internal pure returns (DeploySuite[] memory) {
        ...
        suites[0] = DeploySuite({
            ...
            storedDeployedAddress: MigrationRegistry_0_1_7_DEPLOYED_ADDRESS,
            storedBytecodeHash: MigrationRegistry_0_1_7_BYTECODE_HASH,
        ...
        suites[3] = DeploySuite({
            suite: "migration-registry@0_1_11",
            creationCode: MigrationRegistry_0_1_11_CREATION_CODE,
            storedDeployedAddress: MigrationRegistry_0_1_11_DEPLOYED_ADDRESS,
            storedBytecodeHash: MigrationRegistry_0_1_11_BYTECODE_HASH,
            storedRuntimeCode: MigrationRegistry_0_1_11_RUNTIME_CODE,
            artifactPath: "src/concrete/MigrationRegistry.sol:MigrationRegistry",
            dependencies: abi.decode(MigrationRegistry_0_1_11_DEPENDENCIES, (address[]))
        });
        return suites;
    }
}
